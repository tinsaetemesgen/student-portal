...
const MyGrades = () => {
    ...
    const bestSubject = gradeRecords.length > 0
        ? gradeRecords.reduce((best, r) => r.score > (best?.score || 0) ? r : best, gradeRecords[0])
        : null;
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="bg-white rounded-xl shadow-sm p-5 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 className="text-2xl font-bold">{gradeRecords.length}</h2>
                        </div>
                    </div>
                    <div className="bg-white rounded-xl shadow-sm p-5 flex items-center gap-4">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-5 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 className="text-lg font-bold truncate">{bestSubject?.subject || "N/A"}</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <table className="w-full border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {gradeRecords.length === 0 ? (
                                    <tr><td colSpan={4} className="px-6 py-8 text-center text-gray-500">No grades available yet.</td></tr>
                                ) : (
